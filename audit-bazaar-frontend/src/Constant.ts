// export const API_HOST = "http://10.1.6.72:9000/api/v1";
...
export const APIURL = {
  ...
  USER_UPDATEPROFILE: "/updateProfile",
  USER_REGISTERAUDIT: "/registerAudit",
  USER_MYPROFILE: "/getUserInfo",
  USER_GETUSERAUDIT_POST: "/getDetailsOfAllAudits",
